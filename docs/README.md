...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-22 22:03:14 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Recurrent Convolutional Neural Networks for LiDAR-Based Attitude Initialization of Rotating Spacecraft》（9.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Recurrent Convolutional Neural Networks for LiDAR-Based Attitude Initialization of Rotating Spacecraft">Recurrent Convolutional Neural Networks for LiDAR-Based Attitude Initialization of Rotating Spacecraft</span></li></ul>
  </div>
