...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-21 23:09:20 UTC<br>状态：成功</p>
</section>
...
<p>今日精选2篇论文，精读1篇、速读1篇，聚焦航天器位姿估计与姿态同步。最值得看的是满分精读《HAT: Hypothesis-Anchored Tracking for Video Monocular Spacecraft Pose Estimation》，用假设锚定跟踪做视频单目航天器位姿估计；速读篇则给出无速度测量的矢量姿态同步思路。普通读者可优先从HAT入手，理解视频时序信息如何提升单目位姿精度。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="HAT: Hypothesis-Anchored Tracking for Video Monocular Spacecraft Pose Estimation">HAT: Hypothesis-Anchored Tracking for Video Monocular Spacecraft Pose Estimation</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Velocity-free Attitude Synchronization Using Vector Measurements">Velocity-free Attitude Synchronization Using Vector Measurements</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">pe <strong>1</strong></span></div>
</section>
</div>
